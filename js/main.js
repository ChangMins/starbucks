...
//badge가 스크롤 될 때 사라지게 만들기
const badgeEl = document.querySelector('header .badges');
//to-top요소 찾기
const toTopEl = document.querySelector('#to-top');

//lodash 라이브러리 통해서 사용가능
// _.throttle(함수, 시간)
...
//여러가지 요소들을 시간차로 화면애 나타나도록 애니메이션 처리하기
...
new Swiper('.promotion .swiper-container', {
  ...
  centeredSlides: true, //1번 슬라이드가 중간
  loop: true,
  autoplay: {
    delay: 5000  //5s
  },
